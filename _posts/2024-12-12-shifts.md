...
GUIs that were originally designed for people.  In my work for [Quodor Data](https://welcome.quodor.com/), I built
...
In [Quodor Data's](https://welcome.quodor.com/) interface, for example, the AI assistant is only ever able to edit its
...
BI tool.  It's why I've been working on [Quodor Data](https://welcome.quodor.com/), and why I believe several of these
